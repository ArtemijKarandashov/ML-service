...
class ServiceUnavailableError(Exception):
    """Raised upon requesting unavaliable function in service"""
    pass
...
class StorageServiceAPI():
    ...
    async def delete_pkl_file(self, uid: str):
        ...
        raise ServiceUnavailableError("Deleting .pkl files from trainer-service is unintended. Use backend API instead.")
